            ...
            ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <?= $row['descripcion'] ?>
                        <td class="px-6 py-4">
                            <a href="<?= base_url() ?>clase/editar/<?= $row['id_clase'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                            <a href="<?= base_url() ?>clase/borrar/<?= $row['id_clase'] ?>" class="px-6 py-4 font-medium text-red-600 dark:text-blue-500 hover:underline">Borrar</a>
                        </td>
                    </tr>
            <?php endforeach;
            endif; ?>
