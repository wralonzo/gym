            ...
            ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <?= $row['precio'] ?>
                        <td class="px-6 py-4">
                            <a href="<?= base_url() ?>membresia/editar/<?= $row['id_membresia'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                <i class="bx bxs-edit"></i>
                            </a>
                            <?php if (session()->get('type_user') == 'admin') : ?>
                            <a href="<?= base_url() ?>membresia/borrar/<?= $row['id_membresia'] ?>" class="font-medium text-red-600 dark:text-blue-500 hover:underline">
